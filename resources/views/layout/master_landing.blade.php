...
<head>
    ...
    <title>E-Data BPS Aceh Barat</title>
    <!-- Favicon-->
    <style type="text/css">
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('vendor/landing/assets/img/favicon.ico')}}">
    ...
    <link href="{{asset('vendor/landing/css/styles.css')}}" rel="stylesheet">
</head>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">E - Data BPS Aceh Barat </a><button
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto my-2 my-lg-0">
                 <!-- <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#about">Pencarian</a></li>-->
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#services">Layanan</a></li>
                    <!--<li class="nav-item"><a class="nav-link js-scroll-trigger" href="#portfolio">Portfolio</a></li>-->
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#contact">Tentang</a></li>
                </ul>
            </div>
        </div>
    </nav>
        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center text-center">
                ...
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 font-weight-light mb-5">Cari data - data dan publikasi statistik yang anda butuhkan dengan cepat dan mudah</p>

                    <form class="SeachForm" action="{{route('home.seach_post_new')}}" method="get">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control form-control-lg" id="search" name="search" placeholder="e.g Penduduk Miskin, Pengangguran, etc" aria-label="e.g Penduduk Miskin, Pengangguran, etc"" aria-describedby="basic-addon2">
                            <div class="input-group-append">
                              <button class="btn btn-primary" type="submit" style="background-color: #9b59b6 !important">Cari</button>
                            </div>
                        </div>
                    </form>
                    <br>
                    <br>
                    <br>
                    <a class="btn btn-primary btn-xl js-scroll-trigger" style="background-color: #34495e !important" href="#services"><small>Layanan lainnya</small></a>
                </div>
            </div>
        </div>
    </header>
    <!-- About-->
  <!--  <section class="page-section bg-primary" id="about" style="background-color: #34495e !important">
        <div class="container">
    ...
    <section class="page-section" id="services">
        <div class="container">
            <h2 class="text-center mt-0">Layanan Bagi Anda</h2>
            <hr class="divider my-4">
            <div class="row mx-auto">
                <div class="col-lg-6 col-md-6 text-center">
                    <div class="mt-5">
                        <svg class="svg-inline--fa fa-laptop-code fa-w-20 fa-4x text-primary mb-4" aria-hidden="true"
                            focusable="false" data-prefix="fas" data-icon="laptop-code" role="img"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" data-fa-i2svg="">
                            <path fill="#2c3e50" d="M461.667,49.963c-8.949-8.947-19.698-13.418-32.265-13.418H45.682c-12.562,0-23.317,4.471-32.264,13.418
                ...
                <div class="col-lg-6 col-md-6 text-center">
                    <div class="mt-5">
                        <svg class="svg-inline--fa fa-gem fa-w-18 fa-4x text-primary mb-4" aria-hidden="true"
                ...
                <!--<div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <svg class="svg-inline--fa fa-globe fa-w-16 fa-4x text-primary mb-4" aria-hidden="true"
                        ...
                        </svg> <i class="fas fa-4x fa-globe text-primary mb-4"></i> 
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <svg class="svg-inline--fa fa-heart fa-w-16 fa-4x text-primary mb-4" aria-hidden="true"
                            focusable="false" data-prefix="fas" data-icon="heart" role="img"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                            <path fill="currentColor"
                                d="M462.3 62.6C407.5 15.9 326 24.3 275.7 76.2L256 96.5l-19.7-20.3C186.1 24.3 104.5 15.9 49.7 62.6c-62.8 53.6-66.1 149.8-9.9 207.9l193.5 199.8c12.5 12.9 32.8 12.9 45.3 0l193.5-199.8c56.3-58.1 53-154.3-9.8-207.9z">
                            </path>
                        </svg> <i class="fas fa-4x fa-heart text-primary mb-4"></i> 
        ...
        <div class="container-fluid p-0">
            <div class="row no-gutters">
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="assets/img/portfolio/fullsize/1.jpg"><img class="img-fluid"
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="assets/img/portfolio/fullsize/2.jpg"><img class="img-fluid"
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="assets/img/portfolio/fullsize/3.jpg"><img class="img-fluid"
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="assets/img/portfolio/fullsize/4.jpg"><img class="img-fluid"
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="assets/img/portfolio/fullsize/5.jpg"><img class="img-fluid"
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="assets/img/portfolio/fullsize/6.jpg"><img class="img-fluid"
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mr-auto text-center">
                    ...
                    </svg><!-- <i class="fas fa-envelope fa-3x mb-3 text-muted"></i> -->
                    <!-- Make sure to change the email address in BOTH the anchor text and the link target below!--><a
                        class="d-block" href="mailto:pst1107@bps.go.id"> pst1107@bps.go.id</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <footer class="bg-light py-5">
        <div class="container">
            <div class="small text-center text-muted">Copyright © 2020 - BPS Aceh Barat </div>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
    ...
    <!-- Core theme JS-->
    <script src="{{asset('vendor/landing/js/scripts.js')}}"></script>
